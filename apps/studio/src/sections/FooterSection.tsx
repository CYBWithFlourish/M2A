...
const COMPANY = [
  { label: 'M2A', href: '#' },
  { label: 'GPL v3 License', href: 'https://github.com/CYBWithFlourish/M2A' },
      ...
      <div className="mx-auto max-w-[1400px] px-6 py-12">
        ...
        <div className="mt-10 pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <a href="https://github.com/CYBWithFlourish/M2A" target="_blank" rel="noopener noreferrer" className="text-slate-600 hover:text-slate-400 transition-colors">
